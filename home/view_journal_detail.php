		...
		<div class="alert alert-success">
			...
			if (isset($_SESSION[id])){
				$journal = mysql_query("SELECT * FROM tbl_journal a JOIN tbl_dosen b ON a.id_dosen=b.id_dosen
												JOIN tbl_kategori c ON a.id_kategori=c.id_kategori where a.id_journal='$_GET[journal]'");
			}else{
				$journal = mysql_query("SELECT * FROM tbl_journal a JOIN tbl_dosen b ON a.id_dosen=b.id_dosen
												JOIN tbl_kategori c ON a.id_kategori=c.id_kategori where a.status='1' AND a.id_journal='$_GET[journal]'");
			}	
				mysql_query("UPDATE tbl_journal SET view=view+1 where id_journal='$_GET[journal]'");
				while ($j = mysql_fetch_array($journal)){
					$abstrack = nl2br($j[abstrak]);
					if ($j[status]=='3'){
		                    ...
		                    <tbody>
		                    	<tr><th width='120px'>Author </th><td> <a data-toggle='collapse' href='#collapseExample' aria-expanded='false' aria-controls='collapseExample'>$j[nama]</a>
		                    		<div class='collapse' id='collapseExample'>
									  <div class='well'>
									  	<table>
									  		<tr><td width='120px'>NIDN</td> <td> : $j[nidn]</td></tr>
									  		<tr><td width='120px'>Tempat, Tgl Lahir</td> <td> : $j[tempat_lahir], $j[tanggal_lahir]</td></tr>
										  	<tr><td>No Telpon</td> <td> : $j[no_telpon]</td></tr>
										  	<tr><td>Alamat Lengkap</td> <td> : $j[alamat]</td></tr>
									  	</table>
									  </div>
									</div>
		                    	</td></tr>
		                    	<tr><th>Kategori </th><td> $j[nama_kategori]</td></tr>
		                    	<tr><th>Download </th><td> <a href='download.php?file=$j[file]'>$j[file]</a></td></tr>
		                    	<tr><th>Judul </th><td> <a href=''>$j[judul]</a></td></tr>
		                    	<tr><th>Abstract </th><td> $abstrack</td></tr>";
		                    	if (isset($_SESSION[id])){
			...
			<?php if (isset($_SESSION[id])){ ?>
				<div class="alert alert-info">
			        Semua Revisi <?php if ($_SESSION[level] != 'dosen'){ echo "<a style='margin-top:-5px' class='pull-right btn btn-primary btn-sm' href='' data-toggle='modal' data-target='#tambahrevisi'>Tambahkan Revisi</a>"; } ?>
				</div>
					<?php if ($_SESSION[level] == 'editor'){ ?>
						<ul id="myTabs" class="nav nav-tabs" role="tablist">
							...
							<li role="presentation" class="active"><a href="#revisi2" role="tab" id="revisi2-tab" data-toggle="tab" aria-controls="revisi2" aria-expanded="true">Editor</a></li>
						</ul><br>
						...
						<div id="myTabContent" class="tab-content">
							...
							<div role="tabpanel" class="tab-pane fade active in" id="revisi2" aria-labelledby="revisi2-tab">
								<table class="table table-condensed table-hover">
									<tbody>
									<?php 
