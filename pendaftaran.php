<?php 
	if (isset($_POST[submit])){
		...
		$passs = md5($_POST[b]);
		mysql_query("INSERT INTO tbl_dosen VALUES('','$_POST[g]','$_POST[a]','$passs','$_POST[c]','$_POST[d]','$_POST[e]','$tanggal_lahir','$_POST[jk]','$_POST[f]','Non Aktif')");
						...
						<form action='' method='POST' class="form-horizontal" role="form">
							  ...
							  <label for='inputEmail3' class='col-sm-2 control-label'></label>
								<div class="col-sm-offset col-sm-9"><hr>
								  <button type="submit" name='submit' class="btn btn-success">Kirimkan Pendaftaran</button><br><br>
								</div>
							  </div>
						</form>
			<?php } ?>
