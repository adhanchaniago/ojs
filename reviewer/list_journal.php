			...
			<?php 		
				...
				while ($j = mysql_fetch_array($journal)){
					...
					echo "<tr><td>$no</td>
							  ...
							  <td style='background:#fefcca'>$review</td>
							  <td>$editor</td>
							  <td>$status</td>
							  ...
							  <td width=100px>
							  	  ...
							  	  if ($j[review]=='1'){
							  	  	  echo "<a title='Unapproved This Journal' href='index.php?view=listjournal&journal=$j[id_journal]&publish=0' style='width:35px; margin-left:5px' class='btn btn-warning btn-xs' onclick=\"return confirm('Are You Sure Unpublish this Journal?')\"><i class='glyphicon glyphicon-thumbs-down'></i></a> ";
							  	  }else{
								  	  echo "<a title='Approved This Journal' href='index.php?view=listjournal&journal=$j[id_journal]&publish=1' style='width:35px; margin-left:5px' class='btn btn-info btn-xs' onclick=\"return confirm('Are You Sure Publish this Journal?')\"><i class='glyphicon glyphicon-thumbs-up'></i></a> ";
								  }
							  echo "</td>
						  </tr>";
					$no++;
