	    ...
	    <form action='' method='POST' class="form-horizontal" role="form" enctype='multipart/form-data'>
							  ...
							  <label for='inputEmail3' class='col-sm-2 control-label'></label>
								<div class="col-sm-offset col-sm-9"><hr>
								  ...
								  <a class='btn btn-primary' href='' data-toggle='modal' data-target='#tambahrevisii'>Tambahkan Revisi</a>
								  <?php 
									  if ($e[editor]=='1'){
								  	  	  echo "<a title='Unapproved This Journal' href='index.php?view=myjournal&act=edit&journal=$e[id_journal]&publish=0' style='margin-left:5px' class='btn btn-warning' onclick=\"return confirm('Are You Sure Unapproved this Journal?')\">Unapproved</a> ";
								  	  }else{
									  	  echo "<a title='Approved This Journal' href='index.php?view=myjournal&act=edit&journal=$e[id_journal]&publish=1' style='margin-left:5px' class='btn btn-info' onclick=\"return confirm('Are You Sure Approved this Journal?')\">Approved</a> ";
									  }
