  ...
  <div class="alert alert-danger">
    ...
    <table class="table table-condensed table-hover">
      ...
      <?php 
        ...
        $no = $posisi+1;
        $kategori = mysql_query("SELECT * FROM tbl_dosen a JOIN tbl_jabatan b ON a.id_jabatan=b.id_jabatan ORDER BY a.id_dosen DESC LIMIT $posisi,$batas");
