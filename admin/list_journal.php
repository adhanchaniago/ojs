					...
					echo "<tr><td>$no</td>
							  ...
							  <td width=160px>
							  	...
							  	if ($j[editor]=='1' AND $j[review]=='1'){
								  	  if ($j[status]=='1'){
								  	  	  echo "<a href='index.php?view=journaladmin&journal=$j[id_journal]&publish=0' style='width:35px; margin-left:5px' class='btn btn-warning btn-xs' onclick=\"return confirm('Are You Sure Unpublish this Journal?')\"><i class='glyphicon glyphicon-thumbs-down'></i></a> ";
								  	  }else{
									  	  echo "<a href='index.php?view=journaladmin&journal=$j[id_journal]&publish=1' style='width:35px; margin-left:5px' class='btn btn-info btn-xs' onclick=\"return confirm('Are You Sure Publish this Journal?')\"><i class='glyphicon glyphicon-thumbs-up'></i></a> ";
									  }
								  echo "<a href='index.php?view=journaladmin&act=edit&id=$j[id_journal]' class='btn btn-success btn-xs'><i class='glyphicon glyphicon-edit'></i></a>
								  	    <a href='index.php?view=journaladmin&delete=$j[id_journal]' class='btn btn-danger btn-xs'><i class='glyphicon glyphicon-trash'></i></a></td>";
								}else{
								  	  echo "<a href='' style='width:35px; margin-left:5px' class='btn btn-default btn-xs'><i class='glyphicon glyphicon-thumbs-down'></i></a>
								  	  		<a href='' class='btn btn-default btn-xs'><i class='glyphicon glyphicon-edit'></i></a>
								  	  		<a href='' class='btn btn-default btn-xs'><i class='glyphicon glyphicon-trash'></i></a></td>";
								}
						  echo "</tr>";
					$no++;
				}
