...
?>
  <div class="alert alert-danger">
        Semua Daftar <?php echo $_GET[status]; ?>
    </div>
    ...
    <table class="table table-condensed table-hover">
      ...
      <?php 
        ...
        $no = $posisi+1;
        $users = mysql_query("SELECT * FROM tbl_users a JOIN tbl_jabatan b ON a.id_jabatan=b.id_jabatan where a.level='$_GET[status]' ORDER BY a.id_users DESC LIMIT $posisi,$batas");
