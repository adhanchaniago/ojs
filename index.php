...
<html lang="en">
  <head>
    ...
    <title>Online Journal System</title>
  ...
  <div class="container">
    <?php 
      if (isset($_SESSION[admin])){  
        echo "<img style='width:100%; margin-top:20px' src='asset/images/header-admin.png' />
              <nav class='navbar navbar-inverse'>";
      }else{
        echo "<img style='width:100%; margin-top:20px' src='asset/images/header.png' />
              <nav class='navbar navbar-inverse'>";
      }
    ?>
          ...
          <div class="container">
              <div class="row">
                      <p class="footer" style="text-align:center; color:#fff">
                        Copyright © 2016 Online Journal System<br>
                      </p>
              </div>
          </div>
  </footer>
